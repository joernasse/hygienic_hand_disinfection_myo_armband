...
one_vs_Rest = OneVsRestClassifier(
    BaggingClassifier(SVC(kernel='linear', probability=True, class_weight='balanced', verbose=True),
                      max_samples=1.0 / 12, n_estimators=12, verbose=True), n_jobs=-1)
